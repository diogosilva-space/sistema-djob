...
export function StageChangeModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-foreground/20 p-4">
      <form onSubmit={handleSubmit} className="w-full max-w-md rounded-lg border border-border bg-card p-5 shadow-lg">
        ...
        <div className="mt-5 space-y-2">
          ...
          <Input
            ...
            onChange={(event) => (isWon ? setValue(event.target.value) : setLostReason(event.target.value))}
