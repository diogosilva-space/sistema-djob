...
- **Not a replacement for proper ADR tooling.** `lore` stores decision _summaries_ and pointers; it does not manage decision review, sign-off, or lifecycle beyond `#added` / `#verified` / `#stale` / `#archived` tags.
