        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Registre o progresso desta etapa na produção.
                    </DialogDescription>
                </DialogHeader>
                    ...
                    <div className="space-y-2">
                        ...
                        >
                            <div className="flex items-center space-x-2">
                                ...
                                <Label htmlFor="inicio" className="font-normal cursor-pointer">Iniciar</Label>
                            </div>
                            <div className="flex items-center space-x-2">
                                <RadioGroupItem value="Fim" id="fim" />
                                <Label htmlFor="fim" className="font-normal cursor-pointer">Finalizar</Label>
                            </div>
                        </RadioGroup>
                    </div>
                ...
                <DialogFooter>
                    ...
                    <Button onClick={handleSave} className="h-9">Salvar Apontamento</Button>
                </DialogFooter>
            </DialogContent>
        </Dialog>
    );
