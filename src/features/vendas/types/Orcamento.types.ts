...
export const TECNICAS_PERSONALIZACAO: Record<TecnicaPersonalizacao, TecnicaPersonalizacaoInfo> = {
  BOR: { codigo: 'BOR', nome: 'Bordado', custoBase: 8.0, variavelCusto: 'Por 1000 pontos' },
  ETQ: { codigo: 'ETQ', nome: 'Etiquetas', custoBase: 0.5, variavelCusto: 'Por unidade' },
  IMP: { codigo: 'IMP', nome: 'Impressão Digital', custoBase: 2.0, variavelCusto: 'Por cm²' },
  SUB: { codigo: 'SUB', nome: 'Sublimação', custoBase: 5.0, variavelCusto: 'Por peça' },
  LAS: { codigo: 'LAS', nome: 'Laser', custoBase: 3.0, variavelCusto: 'Por cm²' },
  LAS360: { codigo: 'LAS360', nome: 'Laser Circular', custoBase: 5.0, variavelCusto: 'Por peça' },
  HOT: { codigo: 'HOT', nome: 'Hot Stamping', custoBase: 4.0, variavelCusto: 'Por aplicação' },
  SIL: { codigo: 'SIL', nome: 'Silk Screen', custoBase: 2.0, variavelCusto: 'Por cor' },
  SIL360: {
    codigo: 'SIL360',
    nome: 'Silk Screen Circular',
    custoBase: 3.0,
    variavelCusto: 'Por cor',
  },
  SILTEX: {
    codigo: 'SILTEX',
    nome: 'Silk Screen Têxtil',
    custoBase: 2.5,
    variavelCusto: 'Por cor',
  },
  TAM: { codigo: 'TAM', nome: 'Tampografia', custoBase: 1.5, variavelCusto: 'Por cor' },
  TRA: { codigo: 'TRA', nome: 'Transfer', custoBase: 3.0, variavelCusto: 'Por peça' },
  UVD: { codigo: 'UVD', nome: 'UV Digital', custoBase: 4.0, variavelCusto: 'Por cm²' },
  UV360: { codigo: 'UV360', nome: 'UV Circular (360)', custoBase: 6.0, variavelCusto: 'Por peça' },
};
