        ...
        <div className="space-y-6 pb-12">
            <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                    <Button variant="outline" onClick={() => navigate('/rh')}>Cancelar</Button>
                            ...
                            <div className="flex flex-col md:flex-row gap-8">
                                <div className="flex flex-col items-center gap-4">
                                    <div className="h-32 w-32 rounded-full bg-muted flex items-center justify-center border-2 border-dashed border-muted-foreground/30 relative overflow-hidden group">
                                        <Camera size={32} className="text-muted-foreground group-hover:scale-110 transition-transform" />
                                        <input type="file" className="absolute inset-0 opacity-0 cursor-pointer" />
                                    </div>
                                    <span className="text-[11px] font-medium text-muted-foreground uppercase">Foto 3x4</span>
                                </div>
                                ...
                                <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Input id="naturalidade" placeholder="Cidade onde nasceu" className="h-9 text-sm" />
                                    </div>
                                    <div className="space-y-2">
                                ...
                                <div className="flex flex-col gap-4 border p-4 rounded-md">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-[11px] text-muted-foreground">Optante pelo Vale Transporte</p>
                                        </div>
                                        <Switch />
                                    </div>
                                    <Separator />
